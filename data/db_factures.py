...
#             "numero_facture": "0000405866012024-FINAL",
#             "numero_client_marsa": "7.2571863.16",
#             "date_facture": "01/01/2024",
#             "periode_facturation": "Janvier 2024",
#             "prix_ht": "2 115,00 DH",
#             "montant": "2538.01",
...
#         {
#             "nom_fournisseur": "Maroc Telecom",
#             "numero_facture": "TEST-REJETE-FINAL",
#             "numero_client_marsa": "5.11104.00.00.100006",
#             "date_facture": "05/01/2024",
#             "prix_ht": 900.00,
#             "montant": 500.00,  # montant < prix_ht -> incohérent
...
#         resultat = traiter_facture(facture)
#         print(f"Facture {facture.get('numero_facture')!r} -> {resultat}")

#     # Relance la 1ère pour vérifier la détection de doublon
#     resultat2 = traiter_facture(factures_test[0])
#     print(f"(2e passage) {factures_test[0]['numero_facture']!r} -> {resultat2}")